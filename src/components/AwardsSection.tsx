...
const awards: AwardItem[] = [
  {
    ...
    icon: Trophy,
    image: CDN + 'wp-content/uploads/2020/07/Red-dot-125x127.jpeg',
  },
  {
    title: 'iF Design Award',
    organization: 'iF International Forum Design, Germany',
    year: '2019',
    description: 'Recognised for outstanding design achievement in the building products category, TOSTEM\'s Grants Series set new benchmarks for aluminium window aesthetics and innovation.',
  ...
  },
  {
    ...
    year: '2018',
    description: 'Japan\'s most distinguished design accolade, awarded to TOSTEM for products that significantly enrich daily life through superior design, quality, and user experience.',
  ...
  },
  {
    ...
    year: '2021',
    description: 'Certified for TOSTEM\'s commitment to sustainable manufacturing processes and energy-efficient aluminium products that contribute to green building standards in India.',
  ...
  },
  {
    ...
    year: '2020',
    description: 'Quality management system certification confirming TOSTEM India\'s adherence to internationally recognised standards for manufacturing excellence and continuous improvement.',
    category: 'Quality Assurance',
    icon: Medal,
    image: null,
  },
  {
    title: 'Best Aluminium Window Brand',
    organization: 'Construction World, India',
    year: '2023',
    description: 'Voted India\'s best aluminium window brand by construction industry professionals, recognising TOSTEM\'s market leadership, product innovation, and customer satisfaction.',
